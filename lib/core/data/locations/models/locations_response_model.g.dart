...
Map<String, dynamic> _$LocationCityModelToJson(LocationCityModel instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
LocationAreaModel _$LocationAreaModelFromJson(Map<String, dynamic> json) => $checkedCreate(
  'LocationAreaModel',
  json,
  ($checkedConvert) {
...
Map<String, dynamic> _$LocationAreaModelToJson(LocationAreaModel instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'country_id': instance.countryId,
